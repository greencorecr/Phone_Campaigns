...
<div class="container" style="margin-top: 15%;">
    <div class="row">
		...
		<h3 class="panel-title" style="text-align:center">Campañas Telefónicas</h3>
                </div>
                <?php
              ...
              $error_msg= $this->session->flashdata('error_msg');
                ...
                <div class="panel-body">
                    <form role="form" method="post" action="<?php echo base_url('user/login_user'); ?>campaigns/login_user">
                        <fieldset>
