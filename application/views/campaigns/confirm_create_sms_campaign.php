...
<div id="container" class="container">
    ...
    <div class="panel-body">
     ...
     <div class="main_content">
        ...
        <?=form_open('campaigns/finalize_create_sms_campaign');?>


        <div class="panel panel-primary">
        <div class="panel-heading"><center>{_title_new_sms_campaign}</center></div>
        <div class="panel-body">
        ...
        <div class="row">
            <div class="col-xs-12" style="background-color:#d9edf7;"> <br /></div>
            <center><div class="col-xs-12 col-md-12" style="background-color:#99c4f4;"><?=form_label('{_campaign_label_sms_message}: ', 'sms_message');?></div></center>
            <center><div class="col-xs-12 col-md-12" style="background-color:#d9edf7"><?=$post_data['sms_message']?></div></center>  
            <div class="col-xs-12" style="background-color:#d9edf7;"> <br /><br /></div> 
        </div></br>
        ...
        <div class="div_inputs">
            ...
            <?=form_submit(array('name' => 'confirm', 'class' => 'btn btn-info', 'id' => 'confirm', 'value' => '{_button_confirm}'));?>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#confirm_and_run").click(function(){
            window.location = base_url + 'campaigns/finalize_create_sms_campaign/true';
        });
