...
''?>>{_menu_campaigns}</a></li>
	...
	<li class="dropdown">
          <a style="background-color: #ced8d6;" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo $this->session->userdata('user_name'); ?> <span class="caret"></span></a>
          <ul class="dropdown-menu">
	    <li><a href="<?=base_url()?>campaigns/user_profile">Mi Perfil</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="<?=base_url()?>campaigns/user_logout">Cerrar Sesión</a></li>
          </ul>
        </li>
<!--        <li><a href="#">Salir <?php echo '('.$this->session->userdata('user_name').')'; ?></a></li> -->
        </ul>
      </div>
