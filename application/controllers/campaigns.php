...
//            $data['_split_campaign_warning']); 
        ...
        function Ajax_send_sms() // función dedicada a enviar msjs de prueba por recibiendo los parametros mediante AJAX
        {
            ...
            system("mv ".$tmpfname.' /var/spool/sms/outgoing/'.str_replace('/tmp/', '', $tmpfname));	
...
// nueva parte LOGIN
// verificar nombre de metodo
public function index_user_login(){
...
$this->load->view("campaigns/login.php");
...
//        $this->load->view('campaigns/campaigns.php');
	redirect('campaigns');
...
public function user_profile(){
	 ...
	 $data = get_strings();
         $data['page_title'] = 'Campaign';
         $data['main_content'] = 'campaigns/user_profile';

         $this->parser->parse('includes/template', $data);

//$this->load->view('campaigns/user_profile.php');
...
public function user_logout(){
  ...
  redirect('campaigns/login_view', 'refresh');
